...
class DineInFoodDetailPage extends StatefulWidget {
  final Food food;
  final String restaurantId;
  final String tableId;
  const DineInFoodDetailPage({
    super.key,
    required this.food,
  ...
  @override
  State<DineInFoodDetailPage> createState() => _DineInFoodDetailPageState();
}

class _DineInFoodDetailPageState extends State<DineInFoodDetailPage>
